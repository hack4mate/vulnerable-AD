...
### Example
```powershell
# if you didn't install Active Directory yet, you can try. Be aware that you won't have any Administration tools installed when running this via the PowerShell.
